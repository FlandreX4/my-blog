<template>
    <svg t="1725447649091" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="2304" width="200" height="200">
        <path
            ...
            p-id="2305" fill="currentColor"></path>
        <path
            ...
            p-id="2306" fill="currentColor"></path>
    </svg>
</template>